...
class TraineeServiceTest {
    ...
    @Test
    void testCreateTrainee_generatesIdUsernamePassword_andCallsDao() {
    ...
    @Test
    void testCreateTraineeUsernameSuffix() {
        Trainee existing = new Trainee();
        existing.setId(1L);
        existing.setUsername("John.Doe");

        when(traineeRepository.findAll()).thenReturn(Arrays.asList(existing));
